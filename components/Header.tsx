      ...
      <header className="py-3 sticky top-0 z-50 bg-opacity-80 backdrop-blur-sm" style={{ backgroundColor: '#f8fafce6' }}>
        <div className="md:max-w-7xl mx-auto px-4">
          ...
          <nav className="hidden justify-between lg:flex">
            <div className="flex items-center gap-6">
              <a href="/" className="flex items-center gap-2">
                <Logo size={32} />
                <span className="text-xl text-primary-brand font-bold">SentenceVizu</span>
              </a>
              <div className="flex items-center">
                <ul className="group flex flex-1 list-none items-center justify-center space-x-1">
                  ...
                  <li>
                    <a className="text-muted-foreground hover:text-gray-900 h-10 px-4 py-2 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors" href="#">
                      Blog
                    </a>
                  </li>
                  <li>
            ...
            <div className="shrink-0 flex gap-2 items-center">
              <button className="flex items-center gap-x-2 h-10 px-3 py-2 text-sm text-muted-foreground">
          ...
          <div className="block lg:hidden flex items-center justify-between">
            <a href="/" className="flex items-center gap-2">
              <Logo size={32} />
              <span className="text-xl font-bold">SentenceVizu</span>
            </a>
            <button 
